...
public enum SpecialType {
    ...
    SPEED_BALL(Color.BLUE, DEFAULT_TIME, 0.70),
    WIDER_RAQUET(Color.RED, DEFAULT_TIME, 0.90),
    NARROWER_RAQUET(Color.ORANGE, DEFAULT_TIME, 0.50),
    DOUBLE_BALL(Color.MAGENTA, 0, 0.90),
    HAND_BALL(Color.PINK, DEFAULT_TIME, 0.70),
    LEVELUP(Color.GREEN, 0, 0.10),
    SLOWDOWN_BALL(Color.CYAN, DEFAULT_TIME, 0.80);
